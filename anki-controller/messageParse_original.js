...
module.exports = function() {
  return {
    "parse" : function(data, carName) {
      ...
      // It looks like this event has changed from the SDK.  After much trial/error, I found an interesting bit of info from the message to help me figure out the shape of the track.
      else if (msgId == 0x294) { // ANKI_VEHICLE_MSG_V2C_LOCALIZATION_TRANSITION_UPDATE
        ...
        var msg = {
          "timeStamp": timeStamp,
          "carName" : carName,
          "id" : "0x"+ msgId.toString(16),
          "leftWheelDistance" : leftWheelDistance,
          "rightWheelDistance" : rightWheelDistance,
          "trackStyle" : trackStyle,
          "crossedStartingLine" : crossedStartingLine,
          "speed" : speed };
        //console.log("Message[0x"+msgId.toString(16)+"][Track Event]: ",data,"Left/Right Wheel Distances: "+leftWheelDistance+"/"+rightWheelDistance+" "+trackStyle+crossedStartingLine +" Speed : "+ speed);
        //console.log(msg);
        //return('{"id":"0x'+ msgId.toString(16) +'", "leftWheelDistance":"'+ leftWheelDistance +'","rightWheelDistance":"'+ rightWheelDistance +'","trackStyle":"'+ trackStyle +'","crossedStartingLine":"'+crossedStartingLine+'","speed":"'+speed+'"}');
      }
