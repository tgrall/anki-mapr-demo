define({ "api": [
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/batteryLevel/Skull",
        "type": "curl"
      }
    ],
    "sampleRequest": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/connect/Guardian",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/connect/:carname"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/disconnect/Guardian",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/disconnect/:carname"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/getDevices",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/getDevices"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/ping/Skull",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/ping/:carname"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/rescan",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/rescan"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/turnOnLogging/Skull",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/turnOnLogging/:carname"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/changeLanes/Skull/24",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/changeLanes/:carname/changeValue"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/setLaneOffset/Ground%20Shock/68",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/setLaneOffset/:carname/:changeValue"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/setSpeed/Guardian/600",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/setSpeed/:carname/:speed"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877//trackCountTravel/Skull/15/800",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/trackCountTravel/:carname/:trackCount/:speed"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/flashTaillights/Thermo",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/flashTaillights/:carname"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/setEngineLight/Skull/15/0/15",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/setEngineLight/:carname/:red/:green/:blue"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/turnOffHeadlights/Nuke",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/turnOffHeadlights/:carname"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/turnOffTaillights/Thermo",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/turnOffTaillights/:carname"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/turnOnHeadlights/Nuke",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/turnOnHeadlights/:carname"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:7877/turnOnTaillights/Guardian",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/turnOnTaillights/:carname"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -X GET http://localhost:7877/getTrackMap/medium",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/getTrackMap/:size"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -X GET http://localhost:7877/getTrackMapData",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/getTrackData"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -X POST http://localhost:7877/mapLoad",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/mapLoad"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -X POST http://localhost:7877/mapSave",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/mapSave"
      }
    ],
    "success": {
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -X POST http://localhost:7877/mapTrack/Skull",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:7877/mapTrack/:carname"
      }
    ],
    "success": {
      "examples": [
